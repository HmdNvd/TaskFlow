...
/**
 * Lightweight shadcn-styled wrapper around the native <select>.
 * Kept native (no Radix) so existing form logic, events, and
 * validation continue to work exactly as before — this only
 * changes appearance.
 */
